# BUILDING ON MACOS HAVE TO SPECIFY WHAT PLATFORM
# EXAMPLE: docker build --platform linux/amd64 -t breakseg .

# TODO: Transition files from ipynb to py for running on hpc
